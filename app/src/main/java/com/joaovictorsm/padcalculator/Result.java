...
public class Result implements Serializable {
    // entradas
    private double cobrimento, ap, bp, fyk, cargaPilar, fck, tensaoSolo, acoPilar;
    // saidas
    ...
    public Result(double cobrimento, double ap, double bp, double fyk,
                  double cargaPilar, double fck, double tensaoSolo, double acoPilar,
                  double a, double b, double h, double d,
